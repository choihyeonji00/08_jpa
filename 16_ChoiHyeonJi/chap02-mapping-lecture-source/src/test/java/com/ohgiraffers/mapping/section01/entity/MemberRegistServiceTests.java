...
@SpringBootTest // SPRING ioc 컨테이너 Bean등록떄문에 의존성 주입도 받을 수 있음.
public class MemberRegistServiceTests {
    ...
    void testCreateTable(
      ...
      LocalDateTime enrollDate, MemberRole memberRole, String status
        ...
        // 테스트 시 확인해야하는 거 1. 성공 확인 2. tbl_member 테이블 생성 확인 3. INSERT문 수행 + 테이블 행 확인
        //when
        //then
        Assertions.assertDoesNotThrow( // 예외가 던져지지 않고 정상적으로 실행됐을 떄
