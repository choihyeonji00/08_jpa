...
class EntityManagerCRUDTest {
  ...
  void findMenuByMenuCode(int menuCode, int expected) {
    ...
    // when
    Menu foundMenu = entityManagerCRUD.findMenuByMenuCode(menuCode); // 메뉴 코드 일치하는 거 db 코드에서 찾음
